          ...
          <View style={styles.form}>
            ...
            <Controller
              ...
              render={({ field: { onChange, value } }) => (
                ...
                } value={value} onChangeText={onChange} keyboardType="phone-pad" error={errors.mobile?.message} />
              )}
            />
              ...
              <View style={{ flex: 1, marginRight: SPACING.s }}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Input label={
                      <Text>
                        Check-In (DD/MM/YYYY) <Text style={{ color: 'red' }}>*</Text>
                      </Text>
                    } value={value} onChangeText={onChange} error={errors.checkIn?.message} />
                  )}
                />
              </View>
              <View style={{ flex: 1, marginLeft: SPACING.s }}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Input label={
                      <Text>
                        Check-Out (DD/MM/YYYY) <Text style={{ color: 'red' }}>*</Text>
                      </Text>
                    } value={value} onChangeText={onChange} error={errors.checkOut?.message} />
                  )}
                />
              </View>
            </View>
              ...
              <View style={{ flex: 1, marginRight: SPACING.s }}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Input label={
                      <Text>
                        Rooms <Text style={{ color: 'red' }}>*</Text>
                      </Text>
                    } value={String(value)} onChangeText={onChange} keyboardType="number-pad" error={errors.rooms?.message} />
                  )}
                />
              </View>
              <View style={{ flex: 1, marginLeft: SPACING.s }}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Input label={
                      <Text>
                        Members <Text style={{ color: 'red' }}>*</Text>
                      </Text>
                    } value={String(value)} onChangeText={onChange} keyboardType="number-pad" error={errors.members?.message} />
                  )}
                />
              </View>
            </View>
